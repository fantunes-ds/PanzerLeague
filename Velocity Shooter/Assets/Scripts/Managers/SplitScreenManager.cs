...
public class SplitScreenManager : MonoBehaviour
{
    ...
    private bool m_isSplitScreenInitialized;
...
#endif
        if (SceneManager.GetActiveScene().name != "MainMenu" && !m_isSplitScreenInitialized && GameManager.m_instance.m_isReadyToAddPlayers)
        {
            UpdateSplitScreen(GameManager.m_instance.m_playersToAdd);
            m_scoreManager.Initialize();
            m_playerUIManager.Initialize();
            m_isSplitScreenInitialized = true;
        }
    }
